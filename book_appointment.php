...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($patient_name) || empty($contact_number) || empty($email) || 
        ...
        // Format date to ensure correct format for MySQL
...
$stmt->bind_param(
    "iisssssss",  // Correct type string without space
    $user_id,
    $doctor_id,
    $formatted_date,
    $appointment_time,
...
if ($stmt->execute()) {
    $success_message = 'Appointment scheduled successfully! You will receive a confirmation shortly.';
} else {
